...
$r=cnstats_sql_query("select count(*),cns_languages.eng from cns_log,cns_languages WHERE type=1 AND date>'".$startdate."' AND date<'".$enddate."' AND LEFT(language,2)=cns_languages.code ".$sqlflt." group by cns_languages.eng order by 1 desc");

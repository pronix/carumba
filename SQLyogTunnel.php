...
function AreModulesInstalled ()
{
    ...
    if ( (integer )$versionarry[0] < 4 || ( (integer)$versionarry[0] == 4 && (integer)$versionarry[1] < 3 )){

    $errmsg   = '<b>Error:</b> <b>Your PHP version is: </b>' . $phpversionstr;
    $errmsg  .= '<p><b>SQLyog Tunneling requires PHP version 4.3.0 or above.</b></p>';

	...
	class Sale extends AbstractModule
	{
		...
		function getBlock()
		{
			...
			foreach($items as $item) {
				...
				$style = 'td'.(($i > GetCfg('Sale.itemsPerCol')) ? 'dwn' : 'up').
				            (($i % GetCfg('Sale.itemsPerCol') != 0) ? 'left' : 'right');
			...
			return $content.'<div class="more"><img src="/images/arr_gray2.gif" width="7" height="9"  alt="" /><a href="/catalogue/sale">Подробнее о распродажах</a></div></div>';
		}
		...
		function getTopBlock()
		{
			...
			return $content.'<div class="more"><img src="/images/arr_gray2.gif" width="7" height="9"  alt="" /><a href="/catalogue/sale/">Подробнее о распродажах</a></div>';
		}
		...
		function getFilledSmallTemplate($catItem, $detailed = 0)
		{
			...
			switch($catItem['ptID']) {
				case '5':
				    $imgPercent = '<img src="/images/sale/sale_b_01.gif" width="70" height="70"  alt="" />';
				    break;
				case '6':
				    $imgPercent = '<img src="/images/sale/sale_b_02.gif" width="70" height="70"  alt="" />';
				    break;
				case '7':
				    $imgPercent = '<img src="/images/sale/sale_b_03.gif" width="70" height="70"  alt="" />';
				    break;
			}
		...
		function getRandomBlockItems()
		{
			$query = 'SELECT DISTINCT
					...
					MustUseCompatibility, PicturePath, DescriptionTemplate, ptPercent, pt.ptID, p.xit, p.new,
        ...
        function getItemType($args)
        {
            ...
            {
                case 'Sale':
                    return array('распродажа', 'распродажи', 'распродаже'); //Именит, Род, Дат
            }

...
//            print mysql_num_rows($qr) . "<br />\n";
        ...
        {
            $subs = array ("ж","zh","ё","yo","й","j","ю","yu","ч","ch","щ","sch","ц","tc","у","u","к","k","е","e","н","n","г","g","ш","sh","з","z","х","h","ф","f","ы","y","в","v","а","a","п","p","р","r","о","o","л","l","д","d","э","e","я","ja","с","s","м","m","и","i","т","t","б","b","ь","","ь","Ъ","Ё","Yo","Й","J","Ю","Yu","Ч","Cc","Щ","Sch","Ц","Tc","У","U","К","K","Е","E","Н","N","Г","G","Ш","Sh","З","Z","Х","H","Ф","F","Ы","Y","В","V","А","A","П","P","Р","R","О","O","Л","L","Д","D","Ж","Zh","Э","E","Я","Ja","С","S","М","M","И","I","Т","T","Б","B","Ь","","Ъ","");
            $len = count ($subs);

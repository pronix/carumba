...
<!-- QuickAdmin -->
        <style type=\"text/css\">
            .admblk { font-family: Tahoma, Serif; font-size: 14px; background-color: #DEEBFA; }
        ...
        border-style: double; border-color: #334DFE; padding: 0px 10px 10px 10px; margin: 5px;
        filter:progid:DXImageTransform.Microsoft.dropshadow(OffX=5, OffY=5, Color='gray', Positive='true');
         -moz-opacity: 0.9;\" onmouseover=\"window.clearTimeout(qaTimeOut);\">
            <div style=\"margin-bottom: 5px; margin-top: 0px;\">
            <a href=\"#\" onclick=\"showBlock('QAdm', 0, true); showBlock('QAdmShow', 1, false); return false;\" style=\"font-size: 10px;\">&amp;laquo; скрыть панель администратора</a>
            </div>
            <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"admblk\" width=\"100%\">
                ...
                <a class=\"admlink\" target=\"_blank\" href=\"/admin$realURL\">Редактировать</a>
                 ...
                 | <a class=\"admlink\" target=\"_blank\" href=\"/admin/?cmd=delPage&amp;pageID=$pageID\" style=\"color: red;\" onclick=\"return confirm('Действительно удалить текущий раздел со всеми подразделами?')\">Удалить</a>
                </td>
...
<!-- Hidden QuickAdmin -->
        ...
        font-family: Tahoma, Serif; font-size: 9px; background-color: #DDE6FF; 
        ...
        showBlock('QAdm', 1, true); window.clearTimeout(qaTimeOut); return false;\" style=\"font-size: 10px;\">панель администратора &raquo;</a>
        </div>
        \n";
}
